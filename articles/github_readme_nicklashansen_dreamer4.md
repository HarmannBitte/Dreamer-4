<!-- source: https://github.com/nicklashansen/dreamer4
     fetched: 2026-09-20T13:37:27Z -->
...
```
You are very welcome to contribute to this project! We especially welcome contributions to improve the codebase and bring it closer to the original paper. Feel free to open an issue or pull request if you have any suggestions or bug reports, but please review our [guidelines](https://github.com/nicklashansen/dreamer4/blob/main/CONTRIBUTING.md) first.
