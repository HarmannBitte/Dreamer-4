...
[Diego Marti Monso](https://www.diego-marti.com/)<sup>*</sup>  · 
[Francesco Sacco](https://francesco215.github.io/)<sup>*</sup>  · 
[Edward Hu](https://edwardshu.com/)
...
- Minecraft/VPT-style ArrayRecord data; see [dreamer/data/README.md](https://github.com/next-state/open-dreamer/blob/main/dreamer/data/README.md)
...
```
The dependency lock targets CUDA 12 JAX. If your machine needs a different JAX build, install the correct wheel for your accelerator setup after syncing.
...
in [dreamer/data/README.md](https://github.com/next-state/open-dreamer/blob/main/dreamer/data/README.md).
...
[configs/dataset/minecraft_vpt.yaml](https://github.com/next-state/open-dreamer/blob/main/configs/dataset/minecraft_vpt.yaml). Update
at least:
...
default config is [configs/tokenizer.yaml](https://github.com/next-state/open-dreamer/blob/main/configs/tokenizer.yaml). Edit that
file and [configs/dataset/minecraft_vpt.yaml](https://github.com/next-state/open-dreamer/blob/main/configs/dataset/minecraft_vpt.yaml)
before running:
...
[configs/tokenize.yaml](https://github.com/next-state/open-dreamer/blob/main/configs/tokenize.yaml) first:
...
[configs/dataset/minecraft_vpt_latent.yaml](https://github.com/next-state/open-dreamer/blob/main/configs/dataset/minecraft_vpt_latent.yaml),
...
default config is [configs/dynamics.yaml](https://github.com/next-state/open-dreamer/blob/main/configs/dynamics.yaml), which imports
[configs/dataset/minecraft_vpt_latent.yaml](https://github.com/next-state/open-dreamer/blob/main/configs/dataset/minecraft_vpt_latent.yaml).
...
[configs/eval_fvd.yaml](https://github.com/next-state/open-dreamer/blob/main/configs/eval_fvd.yaml) first:
...
- [configs/tokenizer.yaml](https://github.com/next-state/open-dreamer/blob/main/configs/tokenizer.yaml) - tokenizer architecture and training.
- [configs/tokenize.yaml](https://github.com/next-state/open-dreamer/blob/main/configs/tokenize.yaml) - offline tokenization.
- [configs/dynamics.yaml](https://github.com/next-state/open-dreamer/blob/main/configs/dynamics.yaml) - dynamics architecture and training.
- [configs/eval_fvd.yaml](https://github.com/next-state/open-dreamer/blob/main/configs/eval_fvd.yaml) - rollout and FVD settings.
- [configs/dataset/minecraft_vpt.yaml](https://github.com/next-state/open-dreamer/blob/main/configs/dataset/minecraft_vpt.yaml) - raw MP4 dataset settings.
- [configs/dataset/minecraft_vpt_latent.yaml](https://github.com/next-state/open-dreamer/blob/main/configs/dataset/minecraft_vpt_latent.yaml) - tokenized latent dataset settings.
...
**All rights reserved.** See [LICENSE](https://github.com/next-state/open-dreamer/blob/main/LICENSE). This is a temporary notice; a
