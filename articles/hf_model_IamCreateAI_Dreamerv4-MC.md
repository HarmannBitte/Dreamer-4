<!-- source: https://huggingface.co/IamCreateAI/Dreamerv4-MC
     fetched: 2026-09-20T13:37:21Z -->

[Paper • 2509.24527 • Published  •  8](https://huggingface.co/papers/2509.24527) 
...
- Libraries
-  [Diffusers](https://huggingface.co/IamCreateAI/Dreamerv4-MC?library=diffusers)How to use IamCreateAI/Dreamerv4-MC with Diffusers: pip install -U diffusers transformers accelerate ```
import torch
from diffusers import DiffusionPipeline
# switch to "mps" for apple devices
pipe = DiffusionPipeline.from_pretrained("IamCreateAI/Dreamerv4-MC", dtype=torch.bfloat16, device_map="cuda")
prompt = "Astronaut in a jungle, cold color palette, muted colors, detailed, 8k"
image = pipe(prompt).images[0]
```
- Notebooks
-  [Google Colab](https://huggingface.co/IamCreateAI/Dreamerv4-MC/colab)
-  [Kaggle](https://huggingface.co/IamCreateAI/Dreamerv4-MC/kaggle)
...
[🙋 Ask for provider support](<https://huggingface.co/spaces/huggingface/InferenceSupport/discussions/new?title=IamCreateAI/Dreamerv4-MC&description=React%20to%20this%20comment%20with%20an%20emoji%20to%20vote%20for%20%5BIamCreateAI%2FDreamerv4-MC%5D(%2FIamCreateAI%2FDreamerv4-MC)%20to%20be%20supported%20by%20Inference%20Providers.%0A%0A(optional)%20Which%20providers%20are%20you%20interested%20in%3F%20(Novita%2C%20Hyperbolic%2C%20Together%E2%80%A6)%0A>)