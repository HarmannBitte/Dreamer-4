...
## 13. How the pieces fit together (1/2): data → tokenizer → one transformer
...
## 14. How the pieces fit together (2/2): the two loops
...
## 17. The interactive dynamics model
...
## 18. Primer 1 of 3 · Flow matching: one dial from noise to image
...
## 19. Primer 2 of 3 · Diffusion forcing: a noise level per frame
...
## 20. Primer 3 of 3 · Shortcut models: learning to take big steps
...
## 21. Shortcut forcing: the training objective
...
## 22. Why x-prediction matters for autoregressive world models
...
## 23. Architecture choices that buy speed without losing quality
...
## 24. From world model to agent: agent tokens & heads
...
## 25. Imagination training with PMPO
...
## 26. Part 3 — Experiments

_(no notes)_

## 27. Is the world model accurate? Let humans play inside it
...
## 28. Minecraft world models, stack by stack (1/2): how they are built
...
## 29. Minecraft world models, stack by stack (2/2): how they run
...
## 30. What 'accurate object interactions' looks like
...
## 31. Offline diamond challenge: results
...
## 32. Where do the gains come from? Agent ablations and speed
...
## 33. Unlabeled video: how many action labels are needed?
...
## 34. Inside the imagination: decoded training rollouts
...
## 35. Beyond Minecraft: robotics & egocentric video (qualitative)
...
## 38. Part 4 — Discussion

_(no notes)_

## 39. Limitations the paper itself states
...
## 40. A critical reading: established vs. open
...
## 41. Context: Genie 3 (1/2) — what is actually public
...
## 42. Context: Genie 3 (2/2) — in use, and where Dreamer 4 differs
...
## 43. Where the authors want to take it
...
## 47. Appendix A — Configuration & hyper-parameters

Reference slide; not meant to be presented in full.

## 48. Appendix B — Full design cascade (Table 2)

Numbers transcribed from Table 2 and read off Figure 8.

## 49. Appendix C — Full success-rate table (Table 7, %)
